...
void Intermud::SendPacket(const std::string &type, const std::string &targetmud, const std::string &targetuser, const std::string &message, const std::string &sender)
{
  char* buffer = NULL;
  char* p = NULL;
  char* ar = NULL;
...
void Intermud::SendToAll(const std::string &type, const std::string &message)
{
